        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="rounded-l-lg lg:pl-16 py-10">
            <h3 className="text-headingColor text-[22px]
              leading-9 font-bold mb-10">Create an <span className="text-primaryColor">Account</span>
            </h3>
            <form onSubmit={submitHandler}>
              <div className="mb-5">
                <input
                  ...
                  value={formData.name}
                  className="w-full pr-4 px-4 py-3 border-b border-solid border-[#0066ff61] focus:outline-none focus:border-b-primaryColor
          ...
          text-[16px] leading-7 text-headingColor placeholder:text-textColor rounded-md cursor-pointer"
              ...
              <div className="mb-5 flex items-center gap-3">
                ...
                <div className="realtive w-[130px] h-[50px]">
                  <input
                    type="file"
                    name="photo"
                    id="customFile"
                  ...
                  <label 
                  htmlFor="customFile"
                   className="relative w-full h-full top-0 left-0  flex items-center px-[0.75rem] py-[0.375rem] text-[15px] leading-6 overflow-hidden text-headingColor bg-[#0066ff46] font-semibold rounded-lg truncate cursor-pointer">
                    Upload Photo
                  </label>
                </div>
              </div>
            ...
            <p className="mt-5 text-textColor text-center">Already have an account? <Link to ="/Login" className="text-primaryColor font-medium ">Login</Link>
            </p>
