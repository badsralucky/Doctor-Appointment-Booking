  ...
  return (
    <>
      <section className='bg-[#fff9ea]'>
        <div className="container text-center  mb-8 pb-4">
          <h2 className='heading'><br />Find a Doctor
          </h2>
          <div className="max-w-[570px] mt-[30px] mx-auto bg-[#0066ff2c] rounded-md flex items-center mb-6 justify-between">
